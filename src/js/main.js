...
// Eventlyssnare
document.getElementById('workongoing').addEventListener('change', changeWorkEndState);

function changeWorkEndState() {
    if (this.checked) {
        document.getElementById('workendyear').setAttribute('disabled', true);
        document.getElementById('workendmonth').setAttribute('disabled', true);
    } else {
        document.getElementById('workendyear').removeAttribute('disabled');
        document.getElementById('workendmonth').removeAttribute('disabled');
    }
}
